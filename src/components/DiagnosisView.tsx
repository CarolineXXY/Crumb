    ...
    <div className="flex-1 p-6 flex flex-col justify-between overflow-y-auto bg-[#FAF9F6] text-[#2D2B28]">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[9px] text-stone-400 font-mono flex items-center gap-1 uppercase tracking-wider">
        ...
        <div>
          <span className="text-[9px] font-bold text-[#8B735B] uppercase tracking-widest font-mono">Stage 3: Diagnostic Report</span>
          <h2 className="text-2xl font-serif font-black text-[#2D2B28] tracking-tight mt-0.5">We Found the Culprit</h2>
          <p className="text-xs text-stone-500 mt-1">Here is our forensic analysis based on your symptoms.</p>
        </div>
      </div>
      ...
      <div className="my-5 space-y-4 flex-1">
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#D4D1C9] shadow-md space-y-3.5 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between gap-2 pt-1">
            ...
            <div className={`text-[9px] font-bold px-2.5 py-0.5 rounded uppercase tracking-wider border ${confidenceStyles}`}>
              {diagnosis.confidence} Confidence
            </div>
          </div>

          <div>
            <h3 className="text-lg font-serif font-black text-[#2D2B28] leading-tight">
              {diagnosis.title}
            </h3>
            <p className="text-[10px] text-[#8B735B] font-mono mt-0.5 font-bold uppercase tracking-wider">
              ⚡ {diagnosis.probability} Matching Probability
            </p>
          </div>

          <p className="text-xs text-[#2D2B28]/80 leading-relaxed font-serif italic bg-[#FAF9F6] p-3 rounded-xl border border-[#D4D1C9]/50">
            "{diagnosis.summary}"
          </p>
        </div>
        ...
        <div className="bg-[#2D2B28] text-[#F2F0EB] rounded-2xl p-5 shadow-lg space-y-3">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-[9px] font-bold uppercase tracking-widest font-mono">Your Forensic Action Steps</h4>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#D4D1C9] space-y-3 shadow-xs">
          <div className="flex items-center gap-2 animate-pulse">
            ...
            <h4 className="text-[9px] font-bold text-[#8B735B] uppercase tracking-widest font-mono">The Molecular Science</h4>
          </div>
          ...
          <div className="border-t border-[#D4D1C9]/50 pt-2.5 flex items-center gap-2">
            ...
            <span className="text-[10px] text-stone-400 italic">"{diagnosis.educationalSnippet}"</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-start gap-3 text-left">
            ...
            <div>
              <h4 className="text-[11px] font-bold uppercase tracking-widest leading-none text-[#F2F0EB]">Query Chef Crumb AI</h4>
              <p className="text-[9px] text-[#E8E4DA]/80 mt-1 font-mono">Let's solve baking chemistry, formulas & ratios.</p>
            </div>
          </div>
        ...
        <button
          ...
          className="w-full h-11 bg-transparent hover:bg-[#FAF9F6]/50 text-stone-500 hover:text-stone-700 text-[10px] uppercase tracking-widest font-bold font-mono rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer"
        >
